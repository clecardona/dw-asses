...
export default function TabEducation({ form, setForm, setDisplay }) {
  const [quantity, setQuantity] = useState(
    Array(form.education.length).fill(0)
  );
  const {
    register,
    handleSubmit,
    ...
    <div className="box" key={index}>
      ...
      <label className="school">
        ...
        <input
          type="text"
          defaultValue={
            form.education[index] ? form.education[index].school : ""
          }
          {...register(`${index}school`, { required: true, minLength: 3 })}
        />
        {errors[`${index}school`] && (
          <p className="input-error">Enter Valid Domain({">"} 3 chars) </p>
        )}
      </label>
      ...
      <label className="degree">
        ...
        <input
          type="checkbox"
          defaultValue={
            form.education[index] ? form.education[index].degree : ""
          }
      ...
      <label className="program">
        ...
        <input
          type="text"
          defaultValue={
            form.education[index] ? form.education[index].program : ""
          }
      ...
      <label className="duration">
        ...
        <input
          type="text"
          defaultValue={
            form.education[index] ? form.education[index].duration : ""
          }
